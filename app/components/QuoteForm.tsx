    ...
    <section className="quoteSection sectionShell" id="cotizar">
      <div className="quoteIntro reveal">
        ...
        <p className="quoteSubtitle">
          Sulay revisa tu caso, compara alternativas y te orienta hacia una poliza
          coherente con tu riesgo, presupuesto y momento de compra.
        </p>
      ...
      <form className="quoteCard quoteForm reveal" data-delay="120" onSubmit={handleSubmit}>
